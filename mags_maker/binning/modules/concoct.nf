...
process CONCOCT {
    ...
    depth_file = "${meta.ID}_depth.txt"
    """
    concoct -l ${params.concot_min_contig} \\
            -t ${task.cpus} \\
...
process CUTUP_CLUSTERING {
    ...
    script:
    merged_csv = "clustering_gt${params.concot_min_contig}_merged.csv"
    """
    merge_cutup_clustering.py ${meta.ID}_concoct_clustering_gt${params.concot_min_contig}.csv > ${merged_csv}
    """
}
