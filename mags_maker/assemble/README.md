...
If the pipeline is unable to automatically detect the lack of quality score before assembly steps, it will fail the sample. Set `--lock_phred` to provide `--phred_lock 33` to spades to address these failures case. 
